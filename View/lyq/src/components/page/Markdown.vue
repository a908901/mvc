<template>
    <div class="table">
        ...
        <el-table :date="users" border style="width: 100%"  highlight-current-row >
            <el-table-column prop="ldata" label="日期" sortable width="150">
            </el-table-column>
        ...
        <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
            <el-form  :model="editForm" label-width="80px"  :rules="editFormRules" ref="editForm">
                <el-form-item label="领用日期" prop="ldata">
                    <el-input v-model="editForm.ldata" auto-complete="off"></el-input>
                </el-form-item>
